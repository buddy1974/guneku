        ...
        <div>
          ...
          {isMarcel && n.services && (
            <>
              <h3 style={{ fontFamily:'"Bebas Neue", sans-serif', fontSize:'1.8rem',
                           color:'oklch(0.245 0.022 150)', letterSpacing:'0.05em', margin:'0 0 1.25rem' }}>
                SERVICES
              </h3>
              <div style={{ display:'grid', gridTemplateColumns:'1fr',
                ...
                {n.services.map((s: string) => (
                  <div key={s} style={{ display:'flex', alignItems:'center',
                                        ...
                                        borderLeft:'2px solid oklch(0.320 0.060 158)' }}>
              ...
              <div style={{ display:'grid',
                ...
                {(n.results || []).map((r: string) => (
                  <div key={r} style={{ padding:'1.25rem', backgroundColor:'oklch(0.985 0.008 85)',
                                        borderTop:'2px solid oklch(0.320 0.060 158)' }}>
          ...
          {n.initiative && (
            <>
              ...
              <div style={{ padding:'1.5rem', backgroundColor:'oklch(0.985 0.008 85)',
                ...
                <p style={{ color:'oklch(0.470 0.018 150)',
                  ...
                  <strong style={{ color:'oklch(0.320 0.060 158)' }}>
                    {n.initiative.prize}
                  </strong>
                </p>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ textAlign:'center', marginBottom:'4rem' }}>
              <div style={{ display:'flex', alignItems:'center', justifyContent:'center',
                ...
                <span style={{ width:'28px', height:'2px', backgroundColor:'oklch(0.320 0.060 158)' }} />
              ...
              <div style={{ marginBottom:'4rem' }}>
                ...
                <div style={{ display:'grid',
                  ...
                  {n.services.map((svc: string, i: number) => (
                    <div key={i} style={{ backgroundColor:'oklch(0.985 0.008 85)', padding:'1.5rem',
                                          display:'flex', alignItems:'flex-start', gap:'1rem' }}>
                      <span style={{ color:'oklch(0.320 0.060 158)', fontFamily:'"Bebas Neue", sans-serif',
              ...
              <div style={{ marginBottom:'4rem' }}>
                ...
                <div style={{ display:'grid',
                  ...
                  {n.results.map((r: string, i: number) => (
                    <div key={i} style={{ backgroundColor:'oklch(0.985 0.008 85)',
            ...
            {n.stack && (
              <div style={{ marginBottom:'4rem', textAlign:'center' }}>
                <h3 style={{ fontFamily:'"Bebas Neue", sans-serif', fontSize:'1.8rem',
                             color:'oklch(0.560 0.016 150)', letterSpacing:'0.05em',
                             margin:'0 0 1.5rem' }}>
                  TECH STACK
                </h3>
