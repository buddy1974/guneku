...
const PROJECTS: { id:string; status:string; statusColor:string; title:string; desc:string; year:number; href:string|null }[] = [
  ...
  { id:'hospital',         status:'HISTORICAL',     statusColor:'oklch(0.62 0.010 55)', title:'Open Door Hospital Eye Unit', desc:'The launch of a fully operational eye unit was announced in the village record. Current operating status is not established in the sources.', year:2021, href:null },
