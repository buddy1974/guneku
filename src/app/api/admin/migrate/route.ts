 ...
 *
 * It was added on 2026-09-03 to apply migrations 0000 and 0001, used once, and removed the
 * next morning (64b60b3) because a one-time job does not need a permanent endpoint. It is
 * back for exactly one reason — migration 0002, the profile-claims table — and it goes away
 * again the moment that is applied and verified. If you are reading this in a deployed build
 * and 0002 is already applied, this file should not be here: remove it. */
