 ...
 *   2026-09-05  restored for 0003, the contributions table; removed the same day (238f1af)
 *   2026-09-05  restored for 0004, Palace correspondence — and removed again
 *
 * It is back for exactly one migration and goes away the moment that is applied and
 * verified. If you are reading this in a deployed build and 0004 is already applied, this
